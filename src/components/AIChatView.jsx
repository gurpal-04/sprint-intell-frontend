...
export default function AIChatView() {
  ...
  // Quick Action Chips
  const actionChips = [
    { label: "Why is Sprint 24 delayed?", query: "Why is Sprint 24 delayed?" },
    { label: "Who is overloaded?", query: "Who is overloaded with tasks and reviews?" },
    { label: "Find active build issues", query: "Are there any active staging build failures?" },
...
**How can I help you today?** You can type a question, select a prompt chip below, or click the **Generate Daily Standup Report** bar at the top!`,
          time: new Date()
        }
      ]);
    }
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 h-[calc(100vh-140px)]">
      {/* Main Chat Panel */}
      <div className="xl:col-span-2 glass-card rounded-2xl flex flex-col justify-between overflow-hidden border border-border h-full relative">
      ...
      {/* Standup Generator Side Panel */}
      <div className="glass-card rounded-2xl p-6 border border-border flex flex-col justify-between h-full overflow-hidden">
